...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> getById(long userId, int id) {
        return get("/" + id, userId);
    }

    public ResponseEntity<Object> update(int id, long userId, ItemDto item) {
    ...
    public ResponseEntity<Object> createComment(long userId, long id, CommentDto comment) {
